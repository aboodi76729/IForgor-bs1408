...
{
    // In BS 1.40+, saber blade position getters may be direct fields or renamed.
    // saberBladeTopPos / saberBladeBottomPos → saberBladeTopPosition / saberBladeBottomPosition
